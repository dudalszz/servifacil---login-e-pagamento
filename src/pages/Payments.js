        ...
        <aside className="order-summary">
          ...
          <div className="service">
            <p className="service-title">
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = `${process.env.PUBLIC_URL || ""}/images/icone-limpeza.png`;
                }}
              />
              Serviço de Limpeza
            </p>
            ...
            <div className="provider">
              <img
                src={orderData?.provider?.avatar || "/images/img.png"}
          ...
          <div className="totals">
            <div>
              ...
              <span>
                {orderData.currency === "BRL"
                  ? `R$ ${orderData?.service?.price?.toFixed(2).replace(".", ",")}`
            ...
            <div>
              ...
              <span>
                {orderData.currency === "BRL"
                  ? `R$ ${orderData?.fees?.service?.toFixed(2).replace(".", ",")}`
